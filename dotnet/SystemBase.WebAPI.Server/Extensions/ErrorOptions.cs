...
{
    public static ErrorOptions UseSystemBaseResponseBuilder(this ErrorOptions options, string responseTypeHeader)
    {
        options.ResponseBuilder = (failures, context, statusCode) => {
            context.Response.Headers.Add(responseTypeHeader, SchemaIds.ValidationFailed);
